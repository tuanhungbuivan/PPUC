...
namespace Numeric_lib 
{
	...
	public:
		...
		// BEGIN @LPTCP - Add swap_columns in exercise 11
		void swap_columns(Index pCol1, Index pCol2)
		{
			if (pCol1 == pCol2)
			{
				return;
			...
			{
				std::swap((*this)[i][pCol1], (*this)[i][pCol2]);
			}
		}
		// END @LPTCP - Add swap_columns in exercise 11
	};
